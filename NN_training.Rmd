...
Neural networks are machine learning algorithm that attempts to mimic how human neuronal cells work and the objective of this project is to build a neural network algorithm using Iris dataset to solve multi-classification problems. 
...
The model should predict the speices of isis flower given the sepal length, with and petal length, width. 
...
*Use tables to display actual and predicted values sided by side 
...
The accuracy of the model is checked by converting categorical values into numerical ones and compare them to predicted values. The model has predicted values with 90% accuracy. 
